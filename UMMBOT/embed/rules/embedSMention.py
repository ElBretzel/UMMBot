...
class Embed:
    ...
    def __init__(self, member, channel, message, detect, distance, sanction_id):
        self.member = member
    ...
    async def smention_embed(self):
        ...
        embed = discord.Embed(
            ...
            description=f"{self.member} a envoyé trop de mention a la suite.\nInterval entre {self.distance + 1} messages: {self.detect.seconds}s",
